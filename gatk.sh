...
gatk SelectVariants -V $input1 -sn NEN_001 -sn NEN_003 -sn NEN_200 -sn NEN_300 -sn NEN_4 -sn NEN_5 -sn NEN_6 -O "$out"filtered"$filename".vcf
filename=$(basename "$input2" .vcf)
gatk SelectVariants -V $input2 -sn ROT_004 -sn ROT_006 -sn ROT_007 -sn ROT_013 -O "$out"filtered"$filename".vcf
